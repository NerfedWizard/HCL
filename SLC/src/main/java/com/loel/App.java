...
public class App {
	public static void main(String[] args) {
		...
		Employee e1 = new Employee(1003, "Geeta", 12345);
		Employee e2 = new Employee(1004, "Pradhan", 12345);
		Employee e3 = new Employee(1005, "Olu Funke", 12345);
//		session.save(e1);
//		session.save(e2);
//		session.save(e3);
//		t1.commit();
		...
		Employee er = session.load(Employee.class, new Integer(1003));
