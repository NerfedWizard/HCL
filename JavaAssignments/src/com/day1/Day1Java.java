...
//	private static int total = 0;
	...
	public static void main(String[] args) {
		/**
		 * Probelm 1: System.out.println("-5 + 8 * 6 = " + -5 + 8 * 6);
		 * System.out.println("(55+9) % 9 = " + (55 + 9) % 9); System.out.println("20 +
		 * -3*5 / 8 = " + 20 + -3 * 5 / 8); int x = 5 + 15 / 3 * 2 - 8 % 3;
		 * System.out.println("5 + 15 / 3 * 2 - 8 % 3 = " + x);
		 * 
		 * Problem 2: int y = 20 + 4; System.out.println("20 + 4 = " + y); int x = 20 -
		 * 4; System.out.println("20 - 4 = " + x); System.out.println("20 * 4 = " + 20 *
		 * 4); System.out.println("20 / 4 = " + 20 / 4); System.out.println("20 % 4 = "
		 * + 20 % 4);
		 * 
		 * Problem 3: int total = 0; Scanner sc = new Scanner(System.in); int x = 0;
		 * System.out.println("What is the input? "); int count = 0; do { x +=
		 * sc.nextInt(); count++; } while (count < 3); total = x / count;
		 * System.out.println("The Average of the inputs is: " + total); sc.close();
		 * 
		 */
...
//		int i = 1;
		// 5
//		System.out.println("Is 3 prime? " + primeNumber(x));
